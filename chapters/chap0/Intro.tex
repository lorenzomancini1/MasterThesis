...
\begin{itemize}
    \item[\Cref{chap:hopfield}] We highlight the main theoretical aspects of the \acrlong{hm} (both for the standard version and the modern one), explaining their properties and finally introducing the notion of \acrlong{ba}.
