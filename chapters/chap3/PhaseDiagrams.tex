...
\begin{equation*}
    \alpha_c \gets q.
\end{equation*}
For all our simulations we set $y = 0.5$ in~\cref{eq:pd:solution_fit}. Clearly, everyghing is valid for both the \acrshort{shm} and the \acrshort{mhm}, keeping in mind that, concerning the latter, the critical value depends on $\lambda$.\\
