...
\begin{equation}\label{eq:pesc_definition}
    \pescfull = {\mathbb{E}} \left[ \mathbb{I} \left( \frac{\bsigma_{t} \cdot \bxi[1]}{N} < m_0 \right) \right],
\end{equation}
where $\bsigma_t$ is the output at time $t$ of the zero-temperature \acrlong{mcmc} given that $\bsigma_0$ was exactly $\bxi[1]$. \textbf{scrivere che è uguale se prendo un mu qualsiasi}.
\end{definition}
