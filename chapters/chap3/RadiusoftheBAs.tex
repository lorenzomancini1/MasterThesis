...
In this way we can apply the Brent method in order to compute another $p_c(N)$. If we iterate this procedure many times, we end up with a distribution of finite critical noises. So, the we can use as uncertainty of the standard deviation of such distribution.

\section{Results for the \acrshort{shm}}
\subbibliography
\end{document}